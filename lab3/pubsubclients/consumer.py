...
if __name__ == '__main__':
    ...
    create_subscription("ada2023-413311", "diabetes_res", "diabetes_res_sub")
    pull_message(project="ada2023-413311", subscription="diabetes_res_sub")  # replace ada2023 with your project id
